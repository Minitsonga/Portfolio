    ...
    <div className="holder">
      ...
      <h1 className="text-2xl flex mb-10">
        <p className="m-auto text-center mx-20 px-32">
          Ce jeu avait pour but d'implémentater les controller cross-platform. C'est a dire,
          pouvoir jouer en utilisant le clavier/souris ou la manette.
        </p>
      </h1>
      ...
      <div className="ml-20 mr-14">
        <div className="flex flex-col mt-20">
          ...
          <p className="mx-20 text-lg mb-5">
            ...
            Le second est le mode <span>Endless</span>. Ce mode n'a pas de fin et fonctionne sous forme de vague
            Plus l'on detruit d'astéroïdes, plus l'on gagne d'argent qui nous permettra d'ameliorer nos armes.
            <br />
            <br />
            J'ai ensuite ajouter le système d'<span>Input</span> pour pouvoir changer les touches pour jouer mais aussi
            pour pouvoir changer entre manette ou clavier-souris.
            <br />
            <br />
        ...
        <div className="flex flex-col mt-20">
          ...
          <div className="mx-20 text-lg mb-5">
            <p className="text-xl">
              Ce jeu m'a permis d'approfondir le <span>système de sauvegarde</span> ou 
              la création de <span>prefab</span>.
              <br />
              J'ai aussi pu apprendre utiliser le cross-platform controller. J'ai appris la gestion
              de plusieurs <span>controller</span> (manette et clavier), la <span>modification</span> de nos touches et leur
